        ...
        let insn = match opcode {
            ...
            0x1a => {
                ...
                Instruction::ConstString {
                    dest: aa,
                    string: crate::model::string::StringIdx(idx as u32),
                }
            }
            0x1c => {
                let aa = hi8(unit0);
                ...
                Instruction::ConstClass {
                    dest: aa,
                    type_: crate::model::types::TypeIdx(idx as u32),
                }
            }
            0xfe => {
                let aa = hi8(unit0);
                ...
                Instruction::ConstMethodHandle {
                    dest: aa,
                    method_handle: crate::model::method_handle::MethodHandleIdx(idx as u32),
                }
            }
            0xff => {
                let aa = hi8(unit0);
                ...
                Instruction::ConstMethodType {
                    dest: aa,
                    proto: crate::model::proto::ProtoIdx(idx),
                }
            }
            ...
            0x1b => {
                ...
                instructions.push(Instruction::ConstStringJumbo {
                    dest: aa,
                    string: crate::model::string::StringIdx(idx),
                });
                continue;
            }
            ...
            0x25 => {
                let count = hi8(unit0);
                let type_idx = crate::model::types::TypeIdx(u16_at(buf, unit_off + 2) as u32);
            ...
            0x52..=0x5f => {
                let (a, b) = nibbles(unit0);
                let f = crate::model::field::FieldIdx(u16_at(buf, unit_off + 2) as u32);
                match opcode {
