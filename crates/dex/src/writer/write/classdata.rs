...
pub(crate) fn write_class_data_items(w: &mut DexWriter, dex: &crate::model::dex_file::DexFile) {
    ...
    if class_data_item_count > 0 {
        w.map_entries.push(crate::model::map::MapItem {
            type_code: crate::model::map::TYPE_CLASS_DATA_ITEM,
...
fn write_class_data(
    w: &mut DexWriter,
    data: &crate::model::class::ClassData,
