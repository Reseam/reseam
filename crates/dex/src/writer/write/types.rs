...
use crate::model::map::{MapItem, TYPE_ENCODED_ARRAY_ITEM, TYPE_TYPE_LIST};
...
pub(crate) fn write_hidden_api(
    w: &mut DexWriter,
    hidden_api: &crate::model::hidden_api::HiddenApiData,
    dex: &DexFile,
) {
...
fn write_type_list(w: &mut DexWriter, types: &[crate::model::types::TypeIdx]) {
