use crate::model::annotation::{AnnotationItem, AnnotationsDirectory};
use crate::model::call_site::CallSiteItem;
use crate::model::class::{ClassData, ClassDef, EncodedMethod};
use crate::model::code::CodeItem;
...
use crate::model::method_handle::{MethodHandle, MethodHandleMember};
use crate::model::proto::ProtoIdx;
...
impl<'a> Remap<'a> {
    ...
    fn remap_instruction(&self, insn: &mut crate::model::instruction::Instruction) {
